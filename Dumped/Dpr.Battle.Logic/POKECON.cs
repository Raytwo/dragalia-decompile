...
public sealed class POKECON
{
	...
	public void CopyFrom([In] ref POKECON src)
	{
	}

	public void SetParty(byte clientID, PokeParty srcParty, [In] ref PartyDesc partyDesc, MyStatus playerData)
	{
	}

	private void addPokeParam(byte clientID, byte pokeID, PokemonParam srcParam, [In] ref DefaultPowerUpDesc defaultPowerUpDesc, MyStatus playerData)
	{
	}

	private void setupPokeParam(BTL_POKEPARAM pokeParam, byte pokeID, PokemonParam srcParam, [In] ref DefaultPowerUpDesc defaultPowerUpDesc, MyStatus playerData)
	{
	}
