...
public sealed class FieldStatus
{
	...
	public void CopyFrom([In] ref FieldStatus src)
	{
	}
	...
	public bool AddEffect(EffectType effect, [In] ref BTL_SICKCONT cont)
	{
		return default(bool);
	}

	private bool addEffectCore(EffectType effect, [In] ref BTL_SICKCONT cont, ushort sub_param)
	{
		return default(bool);
	}
	...
	public bool CheckFuin([In] ref MainModule mainModule, POKECON pokeCon, BTL_POKEPARAM attacker, WazaNo waza)
	{
		return default(bool);
	}
